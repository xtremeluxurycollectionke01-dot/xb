      ...
      <div className="max-w-3xl mx-auto bg-white shadow-md rounded-2xl p-8">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>
              We may collect basic information such as name, email address, phone number,
              and usage data when you use our application.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              through the app support section or email us directly.
            </p>
          </section>
